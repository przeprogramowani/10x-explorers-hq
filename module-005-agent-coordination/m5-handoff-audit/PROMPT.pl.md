# Audyt przekazania — Earth HQ

Misja opcjonalna: `q-m5-handoff-audit`. Przeczytaj [politykę](POLICY.pl.md) i [wersję angielską](POLICY.en.md), jeśli jej potrzebujesz.

Warunek gry: **przywrócenie łączności M5**, zapisane na serwerze. Nie musisz aktywować tego zadania.
...
6. Dopiero po potwierdzeniu użyj `earthctl submit --quest-id q-m5-handoff-audit --answer <odpowiedz>`. Nagroda: 0 XP i opcjonalny znacznik ukończenia; główna misja pozostaje aktywna.
