# Change Impact — Earth HQ

Optional mission: `q-m4-change-impact`. Read the [policy](POLICY.en.md), or its [Polish version](POLICY.pl.md).
...
6. Only after approval use `earthctl submit --quest-id q-m4-change-impact --answer <answer>`. Reward: 0 XP and an optional completion stamp; the main mission stays active.
