# Pakiet kontekstu — Earth HQ

Misja opcjonalna: `q-m4-context-pack`. Przeczytaj [politykę](POLICY.pl.md) i [wersję angielską](POLICY.en.md), jeśli jej potrzebujesz.
...
6. Dopiero po potwierdzeniu użyj `earthctl submit --quest-id q-m4-context-pack --answer <odpowiedz>`. Nagroda: 0 XP i opcjonalny znacznik ukończenia; główna misja pozostaje aktywna.
